...
4. Tidy by ~~category~~ data type, not by ~~location~~ data frame - this allows you to see ~~everything you own~~ the units in your data first and to get a grasp of just ~~how much stuff from each category you own~~ what may be stored across several data frames or data objects
...
When tidying your home, you must imagine exactly the kind of lifestyle you want to lead. In tidying your data, you must imagine the ideal dataset for analyses. Luckily, Wickam (2014) has already clearly defined the ideal tidy dataset for us: 
...
<img src="www/obviouslynot.png" alt="troll" width="500px">

## Rule #4: Tidy by data type, not frame 

Determine the units in your data first that may be stored across several data frames or data objects
